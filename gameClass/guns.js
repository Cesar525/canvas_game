...
function gunsType(type, cid, start_posx, start_posy, name, flag) {
	...
	if (type == 3) {
		var EnergyUse_3 = 5;
		var damage_3 = 5;
		cid.gun_on.push(new shots(start_posx, start_posy, 3, 0, 12, damage_3, 0, 100, 100));
	...
	if (type == 5) {
		...
		var damage_5 = 7;
		cid.gun_on.push(new shots(start_posx, start_posy, 5, 0, 7, damage_5, 40, 100, 200, 1, -50, -150));
	}
	...
	if (type == 7) {
		...
		var damage_7 = 10;
		cid.gun_on.push(new shots(start_posx, start_posy, 7, 0, 10, damage_7, 40, 100, 300, 1, -50, -150));
	}
  ...
  cid.gun_on.push(
	...
	if (type == 9) {
		...
		var damage_9 = 8;
		cid.gun_on.push(new shots(start_posx, start_posy, 9, 0, 13, damage_9, 40, 100, 300, 1, -50, -150));
	}
	...
	if (type == 11) {
		var EnergyUse_20 = 30;
		cid.gun_on.push(
			new shots(start_posx + cid.body.lef_side_wign_shot, start_posy, 7, 0, 10, 10, 0, 100, 300, 1, -50, -150),
			new shots(start_posx + cid.body.right_side_wign_shot, start_posy, 7, 0, 10, 10, 0, 100, 300, 1, -50, -150),
			new shots(start_posx, start_posy, 7, 0, 10, 10, 0, 100, 300, 1, -50, -150),
			new shots(start_posx, start_posy, 7, 3, 10, 10, 0, 100, 300, 1, -50, -150),
			new shots(start_posx, start_posy, 7, -3, 10, 10, 0, 100, 300, 1, -50, -150)
		);
	...
	if (cid.body.powerBombEnergy >= 1000 && keys.powerbombactivation.pressed) {
		...
		var damage_1 = 1;
		cid.gun_on.push(
			new shots(start_posx - 150, start_posy - 230, 7, 0, 10, 10, 0, 100, 300, 1, -50, -150, true, 1)
		);
