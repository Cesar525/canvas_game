...
const guns_status_show = {
  ...
  3: {
    icon: weapon_icon[2],
    level: "2",
    gun_name: "Energy Bean",
  },
  4: {
    icon: weapon_icon[2],
    level: "2",
    gun_name: "Energy Bean 2",
  },
  5: {
    icon: weapon_icon[3],
    level: "5",
    gun_name: "Plasma Energy",
  },
  6: {
    icon: weapon_icon[3],
    level: "6",
    gun_name: "Plasma Energy 2",
  },
  7: {
    icon: weapon_icon[4],
    level: "7",
...
const shield_status_show = {
  ...
  1: {
    ...
    name_of_shield: "Energy Shield",
  },
  2: {
    icon: "assets/shields/icon/redshield.png",
    name_of_shield: "Red Plasma Shield",
  },
};
