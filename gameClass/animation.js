class Animation {
  ...
  spritePage(
    ...
    speed,
    show,
    sprite_size_set_width,
    sprite_size_set_height,
    set_transparency
  ) {
    if (
      !sprite_size_set_width &&
    ...
    if (this.show) {
      ...
      let positionX =
        Math.floor(this.gameFrame / this.staggerFrame) % sprite_count_width;
      let positionY =
        Math.floor(this.gameFrame / (this.staggerFrame * sprite_count_width)) %
        sprite_count_height;
      ...
      ctx.drawImage(
        animation,
        1 * (sprite_size_w * this.frameX),
        1 * (sprite_size_h * this.frameY),
        m_width,
        m_height,
        this.position.x,
        this.position.y,
        m_width + 20 + sprite_size_set_width,
        m_height + 20 + sprite_size_set_height
      );
      ctx.globalAlpha = 1;
      ...
      if (
        this.frameX >= sprite_count_width - 1 &&
        this.frameY >= sprite_count_height - 1
      ) {
        this.show = false;
  ...
  getExplosionUseStatus() {
    return this.explosion_used;
  }
  monsterHit(
    animationOne,
    animationTwoo,
    ...
    if (
      !(animationOne.getAnimationStatus() && animationTwoo.getAnimationStatus())
    ) {
  ...
  explosionEffect(effect, posx, posy, send, speed, size_w, size_h) {
    switch (effect) {
      ...
      case 3:
        this.spritePage(
          "assets/explosions/explosion_33.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 9:
        this.spritePage(
          "assets/explosions/lavaexplosion.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 10:
        this.spritePage(
          "assets/explosions/lavaexplosion2.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 11:
        this.spritePage(
          "assets/explosions/lavaexplosion3.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 12:
        this.spritePage(
          "assets/explosions/explosion_yellow.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 13:
        this.spritePage(
          "assets/explosions/explosion_green.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 14:
        this.spritePage(
          "assets/explosions/radiation_explosion.png",
          posx,
          posy,
          2048,
          1280,
      ...
      case 15:
        this.spritePage(
          "assets/explosionparticles/explosion3.png",
          posx,
          posy,
          1000,
          800,
  ...
  burstForBullets(speed, posx, posy, width, height, send) {
    ...
    if (this.show_burst) {
      ...
      burst_bullets.src =
        burst_sprites[
          Math.floor(this.gameFrame / this.staggerFrame) % burst_sprites.length
        ];
      ctx.drawImage(burst_bullets, posx, posy, width, height);

      if (
        Math.floor(this.gameFrame / this.staggerFrame) % 12 ==
        burst_sprites.length - 1
      ) {
        this.show_burst = false;
  ...
  getSpriteProccessorStatus() {
    return this.onSpriteProccessor;
  }
  setSpriteProccessorStatus(set) {
    this.onSpriteProccessor = set;
  }
  ...
  spriteProccessor(sprite, speed, posx, posy, width, height) {
    ...
    this.staggerFrame = speed;
    sparksTwo.src =
      sprite[Math.floor(this.gameFrame / this.staggerFrame) % sprite.length];
    ctx.drawImage(sparksTwo, posx, posy, width, height);
    if (
      sprite.length - 1 ==
      Math.floor(this.gameFrame / this.staggerFrame) % sprite.length
    ) {
      return true;
    } else {
      return false;
  ...
  shieldStartingEffectSelection(
    shield_Animation_selection,
    on_off,
    posx,
    posy
  ) {
    switch (shield_Animation_selection) {
      case 1:
        this.spritePage(
          "assets/shields/shield_arm_top.png",
          posx,
          posy,
          960,
          768,
  ...
  shieldConstantEffectSelectiion(
    shield_Animation_selection,
    on_off,
    posx,
    posy
