...
speed_of_explosion = this.explosion.m_speed;
    ...
    animation.explosionEffect(this.explosion.m_type, this.explosion.m_posx, this.explosion.m_posy, true, speed_of_explosion, this.explosion.m_size_w, this.explosion.m_size_h);
}
